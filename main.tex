...
I'll have to leave the exact formulation of this theorem to smarter people. After all, I did recently score in the bottom 7\% of the GRE's analytical writing section (come on!). The incompleteness theorems for elementary arithmetic can then be recovered from:

\begin{theorem}
The incompleteness theorems apply to every formal system capable of reasoning about a Turing complete domain.
\end{theorem}
...
Elementary arithmetic is thus just one further entry in the long list containing the Game of Life, Fractran, Post Tag Systems, Magic the Gathering, ...\\[2em]
