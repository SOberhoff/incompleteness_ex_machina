...
\setlist[description]{itemsep=0.25pt}
\setlist[itemize]{itemsep=0.25pt}
...
\begin{tikzpicture}[scale=0.75]
  ...
  \begin{scope}
    \clip (0, 0) rectangle (-4cm, 8cm);
    \draw[fill=gray, thick] (0cm, 4cm) circle (4cm);
  \end{scope}
  \begin{scope}
    \clip (0, 0) rectangle (4cm, -8cm);
    \draw[fill=white, thick] (0cm, -4cm) circle (4cm);
  \end{scope}
