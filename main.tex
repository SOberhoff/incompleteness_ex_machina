...
$B(A)$@\footnotemark@
  for $s$ $\in$ all possible strings
    ...
    if $s$ proves @<<@$A(A)$ halts@>>@
      loop
\end{lstlisting}
\end{minipage}\footnotetext{I picked the letters $P$ and $B$ because they visually somewhat resemble the programs they denote. (Also, this is why I placed the ``doesn't halt" case first.)}
